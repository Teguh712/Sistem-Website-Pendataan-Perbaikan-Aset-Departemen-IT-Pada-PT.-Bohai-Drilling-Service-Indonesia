...
");
if (!$goods_result) {
    die("Query Goods Error: " . $conn->error);
}
...
// --- Bagian 1: Manifest ---
$html .= '<h2 style="text-align:center;">Laporan Manifest Perbaikan Aset For Project Manager</h2>';
...
$html .= '<h2 style="text-align:center;">Laporan Detail Perbaikan Aset For Project Manager</h2>';
...
// --- Bagian 3: Goods Form ---
$html .= '<h2 style="text-align:center;">Laporan Goods Form For Project Manager</h2>';
$html .= '<table border="1" cellpadding="6" cellspacing="0" width="100%" style="border-collapse: collapse; font-size:12px;">
<thead style="background:#f0f0f0;">
<tr>
    <th>No</th>
...
$dompdf->render();
$dompdf->stream("Laporan_Keseluruhan_IT_Support_PM.pdf", ["Attachment" => false]);
exit;
